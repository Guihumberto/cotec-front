<template>
    <v-chip-group multiple>
        <v-chip title="Prioridade" small color="primary" v-show="tags.priority" >{{tags.priority}}</v-chip>
        <v-chip
        title="Profisco"
          small
          color="cyan"
        ...
        <v-chip title="Corpo Técnico" small v-show="tags.sector">{{tags.sector}}</v-chip>
